...
iff = open('simulation_values_1_py2.dat','r')
...
if True:
 ...
 for sou in sous:
  ...
  EV = 0.5*np.arctan2(sou[3],sou[2])*180./np.pi
  cplPfr[0].append(Pfr)
  cplPfr[1].append(solved[sou[0][:-1]][0])
  cplPfr[2].append(solvedErr[sou[0][:-1]][0])
  cplEV[0].append(EV)
  cplEV[1].append(solved[sou[0][:-1]][1])
  cplEV[2].append(solvedErr[sou[0][:-1]][1])
  cplRM[0].append(sou[5])
  cplRM[1].append(solved[sou[0][:-1]][2])
  cplRM[2].append(solvedErr[sou[0][:-1]][2])
  cplspix[0].append(sou[4])
  cplspix[1].append(solved[sou[0][:-1]][3])
  cplspix[2].append(solvedErr[sou[0][:-1]][3])
